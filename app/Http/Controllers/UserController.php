...
// jika library di panggil, ketika mengambil dari github, harus melakukan proses pengetikan sebagai berikut
    ...
    public function update(Request $request, $id){
        ...
        if($request->filled('old_password')){
            if(Hash::check($request->old_password, $user->password)){
                ...
                return back()
                ->withErrors(['old_password' => __('Tolong perikasa passwordnya lagi')])
                ->withInput();
            }
        }
