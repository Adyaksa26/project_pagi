...
// contoh routing yang mengarahkan ke dirinya sendiri, tanpa view ataupan controller
Route::get('/salam', function(){
    return "<h1>Selamat pagi all</h1>";
});
...
// middeleware berguna sebagai pembatas atau validasi antara visitor yang
